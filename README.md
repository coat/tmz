...
Parses Maps and Tilesets in [JSON Format](https://doc.mapeditor.org/en/stable/reference/json-map-format/) - `.tmj`, `.tsj`).
...
Building the library requires [Zig 0.13.0](https://ziglang.org/download/#release-0.13.0). To build and run the examples (TODO), [SDL 3.2](https://github.com/libsdl-org/SDL/releases/latest) is also required.
